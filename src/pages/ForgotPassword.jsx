      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <form>
          ...
          <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
            ...
            <p>
              <Link to="/sign-in" className="text-[#9B2226] hover:text-[#B7094C] transition duration-200 ease-linear">Sign in instead</Link>
            </p>
          </div>
          <button className="w-full bg-[#8c5000] text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-[#8c4b00] transition duration-150 ease-in-out hover:shadow-lg active:bg-[#8c2100]" type="submit ">Send reset password</button>
